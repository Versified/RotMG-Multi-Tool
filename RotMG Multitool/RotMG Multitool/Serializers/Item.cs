...
namespace RotMG_Multitool.Serializers
{
    internal class Item
    {
        ...
        public void Serialize()
        {
            ...
            var fullFileName = Path.Combine(desktopFolder, "GeneratedItem.xml");

            var dlr = MessageBox.Show(itemCreatorForm, writer.ToString(), "Finished XML", MessageBoxButtons.YesNo, MessageBoxIcon.Information); // Cannot be metro, text too big doesn't fit.
